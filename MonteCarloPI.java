...
/**
   ...
   Ovaj program izraèunava procenu PI simulirajuæi bacanje strelica(pikado) u kvadrat.
*/
   ...
   public static void main(String[] args) {
      ...
      /*
         ...
         as the ratio circle area / square area = pi / 4
         	...
         	Odnos Pogodaka / Pokušaja je približno jednak
         	odnosu (površine 1/4) Kruga / (površine) Kvadrata = pi / 4
      */        
